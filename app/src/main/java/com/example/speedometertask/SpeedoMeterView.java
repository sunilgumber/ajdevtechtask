...
public class SpeedoMeterView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float angle=270.0f+(180*currentSpeed)/140.0f;
        canvas.save();
...
//        canvas.drawArc(new RectF(80,80,getWidth()-80,getHeight()-80),180,180,false,paint);
//        paint.setColor(Color.GREEN);
//        canvas.drawArc(new RectF(80,80,getWidth()-80,getHeight()-80),180,180,false,paint);


        paint.setStrokeWidth(radius/66.26f);
        paint.setStyle(Paint.Style.STROKE);

        paint.setColor(Color.RED);
        RectF rect=new RectF((strokewidth*2.0f)+paint.getStrokeWidth()/2.0f,(strokewidth*2.0f)+paint.getStrokeWidth()/2.0f,getWidth()-(strokewidth*2.0f)-paint.getStrokeWidth()/2.0f,getHeight()-(strokewidth*2.0f)-paint.getStrokeWidth()/2.0f);
        canvas.drawArc(rect,
                180,180,false,paint);
        ...
        int point=-60;
        int lastodd=0;
        for (int i=90+180;i<=90+180+180;i+=9f){
            ...
            if (lastodd==0){
                ...
                canvas.drawLine(getWidth()/2.0f,10,getWidth()/2.0f,radius/12.90f,linepaint);
            }
            else {
                linepaint.setStrokeWidth(radius/98.5f);
                canvas.drawLine(getWidth()/2.0f,10,getWidth()/2.0f,radius/24.26f,linepaint);
            }
            if (lastodd==0){
                canvas.translate(0,radius/9.13f);
                point+=10;
                TextPaint textPaint=new TextPaint(Paint.ANTI_ALIAS_FLAG);
                textPaint.setTextSize(radius/15.13f);
